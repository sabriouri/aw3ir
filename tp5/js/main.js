    ...
    app = new Vue({
        ...
        methods: {
            ...
            meteo: function (_city) {
                ...
                fetch('https://api.openweathermap.org/data/2.5/weather?q=' + _city.name + '&units=metric&lang=fr&apikey=7f43e12b61673338ed978dc3659910c7')
                    .then(function (response) {
                        return response.json();
                    })
                    .then(function (json) {
                        this.cityWeatherLoading = false; // Fin du chargement
